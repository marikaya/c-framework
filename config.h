...
#define BNETD_DEFAULT_CONF_FILE "/usr/local/etc/module/bnetd.conf"
#define D2CS_DEFAULT_CONF_FILE "/usr/local/etc/module/d2cs.conf"
#define D2DBS_DEFAULT_CONF_FILE "/usr/local/etc/module/d2dbs.conf"
